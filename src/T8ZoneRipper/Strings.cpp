...
std::string& Strings::StartTrim(std::string& Value)
{
	// Clean it up
...
std::string& Strings::EndTrim(std::string& Value)
{
	// Clean it up
...
std::string& Strings::Trim(std::string& Value)
{
	// To both
	return StartTrim(EndTrim(Value));
}
